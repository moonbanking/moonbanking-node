# Moonbanking TypeScript API Library
...
This library provides convenient access to the Moonbanking REST API from server-side TypeScript or JavaScript.
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/moon-banking-typescript.git
```
...
1. Via the `MOONBANKING_LOG` environment variable
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/moon-banking-typescript/issues) with questions, bugs, or suggestions.

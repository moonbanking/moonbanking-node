...
export namespace BankGetResponse {
  /**
   * The bank model contains information about financial institutions.
   */
...
export interface BankGetByHostnameResponse {
  data: Array<BankGetByHostnameResponse.Data>;
...
export namespace BankGetByHostnameResponse {
  /**
   * The bank model contains information about financial institutions.
   */
  export interface Data {

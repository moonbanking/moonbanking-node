...
const environments = {
  production: 'https://api.moonbanking.com/v1',
  beta: 'https://api-dev.moonbanking.com/v1',
};
...
export interface ClientOptions {
   ...
   * - `production` corresponds to `https://api.moonbanking.com/v1`
   * - `beta` corresponds to `https://api-dev.moonbanking.com/v1`
   */

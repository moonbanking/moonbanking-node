...
export class Countries extends APIResource {
  ...
  listStories(
    ...
    options?: RequestOptions,
  ): APIPromise<CountryListStoriesResponse> {
    return this._client.get(path`/countries/${code}/stories`, { query, ...options });
  }
}
...
export interface CountryListStoriesParams {
  /**
   * An optional comma-separated list of fields to include in the response. Possible

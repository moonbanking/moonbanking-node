...
Full Changelog: [v0.10.1...v0.10.2](https://github.com/moonbanking/moonbanking-node/compare/v0.10.1...v0.10.2)

### Chores

* update Node.js version in publish workflow and remove provenance flag from npm publish command ([5ac89e5](https://github.com/moonbanking/moonbanking-node/commit/5ac89e5791b22ba95cf483395f3288126ef05ea2))

## 0.10.1 (2026-04-10)

Full Changelog: [v0.10.0...v0.10.1](https://github.com/moonbanking/moonbanking-node/compare/v0.10.0...v0.10.1)

### Chores

* add provenance flag back to npm publish command ([5b66de1](https://github.com/moonbanking/moonbanking-node/commit/5b66de14bc92c6c3271daeed36e476238eeb9cb0))
...
* remove provenance flag from npm publish command ([3ff3dba](https://github.com/moonbanking/moonbanking-node/commit/3ff3dba6a701e6783ebcfbba8915d967264aead4))
...
* **api:** update api ([88264bc](https://github.com/moonbanking/moonbanking-node/commit/88264bcc67fca9caa13fc39db05f5a8bab0210eb))

## 0.7.0 (2026-02-11)

Full Changelog: [v0.6.4...v0.7.0](https://github.com/moonbanking/moonbanking-node/compare/v0.6.4...v0.7.0)

### Features

* **api:** manual updates ([b5cd9e0](https://github.com/moonbanking/moonbanking-node/commit/b5cd9e0420d47385fa5442849eafb932c7f87d36))
* **api:** update api ([94b4bbf](https://github.com/moonbanking/moonbanking-node/commit/94b4bbfccf2ba818b12f28252678b0822309fee1))
